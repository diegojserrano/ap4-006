...
public class Principal {
    ...
    public static void main(String[] args) throws SQLException, IOException {
        ...
        Connection conn = DriverManager.getConnection("jdbc:mariadb://localhost/Super006", "root", "root");
        ...
        while(rs.next()) {
            // Una vuelta por cada fila de la tabla
        ...
        System.out.println("Productos de mas de $1000: " + t.getMasDe1000());
